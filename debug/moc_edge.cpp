...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Edge_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject Edge::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Edge.data,
    qt_meta_data_Edge,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *Edge::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Edge.stringdata0))
